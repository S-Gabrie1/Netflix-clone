...
export default function PinContainer({
  ...
  return (
    showPinContainer && (
      <div className="z-[100] bg-black flex-col min-h-screen absolute left-0 top-0 justify-center flex items-center right-0">
        <div>
          <span
            onClick={() =>
              setShowPinContainer({
        ...
        <h1 className="text-gray-400 fond-bold text-[16px] mb-4">
          Profile Lock is currently ON
        </h1>
        {pinError ? (
          <h2 className="text-[#e6b209] font-bold text-[30px]">
            Whopps, wrong PIN. Please try again
          </h2>
        ) : (
