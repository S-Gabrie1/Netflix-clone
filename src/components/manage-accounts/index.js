  ...
  return (
    <div className=" min-h-screen flex justify-center flex-col items-center relative">
      <div className=" flex justify-center flex-col items-center">
        ...
        <ul key={accounts} className="flex gap-8 p-0 my-[25px]">
          {accounts && accounts.length
            ? accounts.map((item) => (
                <li
                  className=" max-w-[200px] w-[155px] items-center gap- flex flex-col cursor-pointer min-w-[200px] "
                  key={item.id}
          ...
          {accounts && accounts.length < 4 ? (
            <li
              ...
              className=" border text-black bg-[#e5b109] font-bold text-lg mr-5 ml-5 border-black max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] w-[155px] h-[155px] cursor-pointer flex justify-center items-center "
            >
              Add Account
            </li>
          ) : null}
