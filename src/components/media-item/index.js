...
export default function MediaItem({
  ...
  return (
    ...
    >
      <div className="relative cursor-pointer overflow-x-auto cardWrapper h-30 min-w-[180px] md:h-36 md:min-w-[260px] transform transition duration-500 hover:scale-110 hover:z-[999]">
        <Image
